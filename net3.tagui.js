...
var flow_path = 'E:/PS/Tag';

casper.start('https://www.excellbroadband.com/userzone.html', function() {
techo('https://www.excellbroadband.com/userzone.html' + ' - ' + this.getTitle() + '\n');});

casper.then(function() {{techo('type customerid as 21289');
casper.waitFor(function check() {return check_tx('customerid');},
function then() {this.sendKeys(tx('customerid'),'21289');},
function timeout() {this.echo('ERROR - cannot find customerid').exit();});}});

casper.then(function() {{techo('type phone as 9866909000');
casper.waitFor(function check() {return check_tx('phone');},
function then() {this.sendKeys(tx('phone'),'9866909000');},
function timeout() {this.echo('ERROR - cannot find phone').exit();});}});

casper.then(function() {{techo('type custip as 172.16.233.50');
casper.waitFor(function check() {return check_tx('custip');},
function then() {this.sendKeys(tx('custip'),'172.16.233.50');},
function timeout() {this.echo('ERROR - cannot find custip').exit();});}});

// here we need to get the ocr recognition
casper.then(function() {{techo('snap /html/body/div[1]/div[3]/form/table/tbody/tr[4]/td[4]/img to ocr.png');
casper.waitFor(function check() {return check_tx('/html/body/div[1]/div[3]/form/table/tbody/tr[4]/td[4]/img');},
function then() {this.captureSelector('E:/PS/Tag/ocr.png',tx('/html/body/div[1]/div[3]/form/table/tbody/tr[4]/td[4]/img'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[1]/div[3]/form/table/tbody/tr[4]/td[4]/img').exit();});}});
