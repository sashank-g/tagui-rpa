...
//  https://api.ocr.space/parse/imageurl?url=http://dl.a9t9.com/ocrbenchmark/eng.png&language=eng&apikey=640c8334fe88957
casper.then(function() { // start of JS code
num=1
url = "https://jsonplaceholder.typicode.com/todos/" + num.toString()
}); // end of JS code

// api https://jsonplaceholder.typicode.com/todos/1
// js url = "https://jsonplaceholder.typicode.com/todos/1"
casper.then(function() {{techo('api url');
api_result = ''; api_result = call_api('url');
try {api_json = JSON.parse(api_result);} catch(e) {api_json = JSON.parse('null');}}});

casper.then(function() {this.echo(api_result);});
...
casper.then(function() {this.echo(result);});
